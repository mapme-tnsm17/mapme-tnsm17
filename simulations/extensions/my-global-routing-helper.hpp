...
#ifndef MY_GLOBAL_ROUTING_HELPER_H
#define MY_GLOBAL_ROUTING_HELPER_H

#ifndef GLOBALROUTING_UPDATES
#error "This extension requires the GLOBALROUTING extension"
...
public:
  ...
  static void
  CalculateRoutesForPrefix(Name const & prefix);
...
#ifdef STRECH_N  
  static int
  getSPTdistanceBetweenAp(uint32_t fromNodeId, uint32_t toNOdeId);

protected:
   static std::unordered_map<uint32_t, uint32_t> m_ap_distance_map;
#endif
...
#endif // MY_GLOBAL_ROUTING_HELPER_H
