...
#ifndef NDN_RATE_L3_TRACER_NG_H
#define NDN_RATE_L3_TRACER_NG_H
 ...
 */
class L3RateTracerNg : public L3Tracer {
public:
  /**
   ...
   */
  L3RateTracerNg(shared_ptr<std::ostream> os, Ptr<Node> node);
   ...
   */
  L3RateTracerNg(shared_ptr<std::ostream> os, const std::string& node);

  /**
   * @brief Destructor
   */
  virtual ~L3RateTracerNg();
