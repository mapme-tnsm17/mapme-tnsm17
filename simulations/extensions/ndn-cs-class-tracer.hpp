...
#ifndef CCNX_CS_CLASS_TRACER_H
#define CCNX_CS_CLASS_TRACER_H
...
struct StatsDown {
  ...
  double m_cacheHitsDown;
  double m_cacheMissesDown;
};
/// @endcond
}
 ...
 */
class CsClassTracer : public SimpleRefCount<CsClassTracer> {
public:
  /**
   ...
   */
  CsClassTracer(shared_ptr<std::ostream> os, Ptr<Node> node);
   ...
   */
  CsClassTracer(shared_ptr<std::ostream> os, const std::string& node);
 ...
 */
inline std::ostream&
operator<<(std::ostream& os, const CsClassTracer& tracer)
{
  os << "# ";
