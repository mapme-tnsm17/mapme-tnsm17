...
class MobileFatTreeTopologySinglePathWithBorder : public NodeContainer {

public:
    MobileFatTreeTopologySinglePathWithBorder(NodeContainer & Leaves, Options & options, bool has_meshed_leaves = true);
