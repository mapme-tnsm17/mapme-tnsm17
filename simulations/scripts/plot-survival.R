...
colors <- list("0.8"="red", "1.2"="blue")


for (alpha in c("0.8", "1.2")) {
    temp_dfm <- read.table(paste("./data/r0.5-K10000-C1-s100-a", alpha, "-d100000/1/survival.out", sep=''))
